            ...
            <div className="flex bg-gray-100 text-gray-900">
                ...
                <aside className="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-white">
                    <nav className="flex flex-1 flex-col gap-y-4 pt-10">
                        ...
                        <a href="/dash" className="text-gary-400 bg-gray-100 group relative rounded-xl z-20 p-2 hover:scale-105 hover:bg-gray-200 hover:shadow-md ease-in-out duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <a href="/dash/messages" className="text-gary-400 bg-gray-100 group z-20 relative rounded-xl p-2 hover:scale-105 hover:bg-gray-200 hover:shadow-md ease-in-out duration-300">
